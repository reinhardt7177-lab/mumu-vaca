...
export default function HomePage() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-xl items-center px-4 py-7 sm:px-6 sm:py-9">
        <article className="w-full rounded-[1.35rem] border border-white/45 bg-white/16 p-4 text-white shadow-[0_20px_60px_rgba(13,22,16,0.35)] backdrop-blur-md sm:p-5">
